...
こうした客観的な評価は、AI時代のエンジニアにとって不可欠な能力です。「なんとなく読みづらい」「多分大丈夫」といった感覚的な評価は、チーム開発やAIとの協働では通用しません。具体的には、次の三つの効果があります。
...
行数という第一の指標を理解したら、次はコードの「分岐の多さ」を測る、より本質的な指標に踏み込みましょう。コードの中に「独立した実行経路」がいくつあるかを示すのが循環的複雑度です。1976年にThomas McCabeが提唱した伝統的な指標です。
...
循環的複雑度がコードの構造を数値化するなら、認知的複雑度はその数値が「人間の読みやすさ」とどう結びつくかをより精密に捉えます。「人間にとってどれくらい理解しづらいか」を測る、2016年にSonarSourceが提唱した現代的な指標であり、循環的複雑度と異なり**ネストの深さ**を重く評価します。
...
警告の内容が分かれば、具体的にどう修正するかが見えてきます。指摘を受けて、ガード節を使ったり関数を分けたりして修正します。
