...
正常系が明確になれば、それが術式の「幹」になります。幹が定まれば、次は「枝」、すなわち異常系に目を向けましょう。
...
異常系は正常系の「枝」として扱います。幹と枝を分離することで、術式の見通しが良くなります。この構造が整ったら、図に落とし込んで全体を俯瞰する習慣をつけましょう。
...
分岐の技法に続き、次はコードを繰り返し実行させる「ループ」の使い分けを見ていきます。
...
分岐とループで「通常の流れ」を制御できるようになったら、次は想定外の事態——例外——への備えに目を向けましょう。
