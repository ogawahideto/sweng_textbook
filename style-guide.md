...
『「楽しい」ソフトウェア工学の攻略本 —— デジタル・アルケミー：伝統の美学とAIで紡ぐ創造の地図』の執筆スタイルを統一するためのガイドです。
...
**良い例**:
> ソフトウェア工学は、魔法の地図のようなものです。複雑な現実世界を、美しく整理された論理の世界へと翻訳していく技術です。この章では、その翻訳の技法を学びましょう。

**避けるべき例**:
> ソフトウェア工学とは、ソフトウェア開発における体系的なアプローチである。本章では要求工学について説明する。
...
本書は従来のソフトウェア工学攻略本と異なり、**課題や問題からではなく、可能性や価値から語ります**。
...
本方針の目的は「読者を萎縮させない」「ソフトウェア工学をべからず集にしない」ことであり、技術的な制約や特性を正確に説明することを妨げるものではありません。
...
コードやアーキテクチャの「良し悪し」を評価することは、ソフトウェア工学の本質です。読者の行動を否定せず、ソフトウェアそのものを評価対象とする表現は問題ありません。
